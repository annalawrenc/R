...
#-----------------------------------------------------------------------------------------------------------------------
#Realizar un gra???co de dispersion para las variables que tienen mas y menos correlacion con Y y comentar los resultados. 
...
#outliers <- apply(buscar_outlier, 1, any)
...
predicho <- predict(regresion)
plot(predicho)

ecm <- mean((entrenamiento-predicho)^2)
